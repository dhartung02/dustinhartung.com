...
export const opportunities: Opportunity[] = [
  ...
  {
    id: "op-cedarpoint",
    role: "PM, Platform Data",
    company: "Cedarpoint Systems",
    tier: "B",
    fitLabel: "Strong",
    stage: "open",
    today: true,
    ...
    ev: 4.1,
    location: "Remote (US)",
    salaryRange: "$160K–195K est.",
    linkConfidence: "Verified",
    nextAction: "Tier B, verified, still open — apply this week",
  },
  {
    id: "op-vantage",
    role: "Sr PM, Robotics",
    ...
    salaryRange: "$150K–185K est.",
    linkConfidence: "Board-only",
    nextAction: "New since last scout run — review and verify",
  },
  {
    id: "op-harborlight",
    role: "PM, Data Platform",
    ...
    ev: 4.0,
    location: "Remote (US)",
    salaryRange: "$175K–210K est.",
    linkConfidence: "Verified",
    nextAction: "Tier A, not yet applied — prioritize",
  },
  {
    id: "op-greenfield",
    role: "Group PM, Analytics",
  ...
  },
  {
    ...
    ev: 3.0,
    location: "Remote (US)",
    salaryRange: "$155K–185K est.",
    linkConfidence: "Verified",
    nextAction: "Applied 9 days ago — awaiting response",
  },
  {
    id: "op-anchor",
    role: "PM, Payments",
    company: "Anchor Financial",
    tier: "A",
    fitLabel: "Excellent",
    stage: "applied",
    today: true,
    ...
    salaryRange: "$180K–220K est.",
    linkConfidence: "Verified",
    nextAction: "Applied 5 days ago — awaiting response",
  },
  {
    id: "op-brightpath",
    role: "PM, Logistics",
    ...
    salaryRange: "$145K–175K est.",
    linkConfidence: "Board-only",
    nextAction: "Applied 20 days ago, no contact — follow up",
  },
  {
    id: "op-delta",
    ...
    salaryRange: "$170K–205K est.",
    linkConfidence: "Verified",
    nextAction: "Panel round scheduled next week",
  },
  {
    id: "op-foxglove",
    role: "PM, Content",
    ...
    salaryRange: "$130K–155K est.",
    linkConfidence: "Verified",
    nextAction: "Rejected after recruiter screen — archive",
  },
  {
    id: "op-ironwood",
    role: "Sr PM, Supply Chain",
    ...
    salaryRange: "$125K–150K est.",
    linkConfidence: "Board-only",
    nextAction: "Posting detected closed — archive",
  },
  {
    id: "op-nimbus",
    role: "PM, Claims",
    company: "Nimbus Insurance",
    tier: "B",
    fitLabel: "Strong",
    stage: "rejected",
    today: false,
  ...
  },
  {
    ...
    salaryRange: "$120K–145K est.",
    linkConfidence: "Unverified",
    nextAction: "Rejected — archive",
  },
];
